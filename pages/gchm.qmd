...
tiles <- st_read("../resources/data/final_tile_selection.gpkg", quiet = TRUE)
...
![Fig. 1: Average absolute relative difference to the original prediction by degree of manipulation, for all bands and locations.](../resources/gchm/gchm_result.png)


## Slides

<!-- [Here](/resources/gchm/presentation_slides.pdf) can you find the presentation of the ILÖK Graduate Conference. -->

<a href="/resources/gchm/presentation_slides.pdf" class="btn btn-primary" target="_blank">Conference slides (PDF)</a>
